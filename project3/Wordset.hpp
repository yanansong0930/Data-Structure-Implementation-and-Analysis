...
private:
    ...
    std::string* wordSetArray;
    int pos;    // track the current capacity and find next capacity by adding 1 if over load factor
    int cap;    // the capacity of wordSetArray
    int sz;     // the current size of wordSetArray
    void initArray();
